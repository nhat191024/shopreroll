...
class StoreGameAccountRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'game_category_id.required' => 'ID danh mục game là bắt buộc',
            'game_category_id.integer' => 'ID danh mục game phải là một số nguyên',
            ...
            'game_items.required' => 'Các mục tài khoản game là bắt buộc',
            'game_items.array' => 'Các mục tài khoản game phải là một mảng',
            'game_items.*.array' => 'Các mục tài khoản game phải là một mảng',
            'game_items.*.*.required' => 'Mục tài khoản game là bắt buộc',
            'game_items.*.*.integer' => 'Mục tài khoản game phải là một số nguyên',
            'game_attributes.required' => 'Thuộc tính tài khoản game là bắt buộc',
            'game_attributes.array' => 'Thuộc tính tài khoản game phải là một mảng',
            'game_attributes.*.array' => 'Thuộc tính tài khoản game phải là một mảng',
            'game_attributes.*.*.required' => 'Thuộc tính tài khoản game là bắt buộc',
            'game_attributes.*.*.string' => 'Thuộc tính tài khoản game phải là một chuỗi',
            'game_attributes.*.*.max' => 'Thuộc tính tài khoản game không được vượt quá 255 ký tự',
        ];
    }
}
