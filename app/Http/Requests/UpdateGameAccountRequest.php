...
class UpdateGameAccountRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'game_items.required' => 'Vật phẩm tài khoản game là bắt buộc',
            'game_items.array' => 'Vật phẩm tài khoản game phải là một mảng',
            'game_items.*.array' => 'Vật phẩm tài khoản game phải là một mảng',
            'game_items.*.*.required' => 'Vật phẩm tài khoản game là bắt buộc',
            'game_items.*.*.integer' => 'Vật phẩm tài khoản game phải là một số nguyên',
            'game_attributes.required' => 'Thông tin chi tiết tài khoản game là bắt buộc',
            'game_attributes.array' => 'Thông tin chi tiết tài khoản game phải là một mảng',
            'game_attributes.*.array' => 'Thông tin chi tiết tài khoản game phải là một mảng',
            'game_attributes.*.*.required' => 'Thông tin chi tiết tài khoản game là bắt buộc',
            'game_attributes.*.*.string' => 'Thông tin chi tiết tài khoản game phải là một chuỗi',
            'game_attributes.*.*.max' => 'Thông tin chi tiết tài khoản game không được vượt quá 255 ký tự',
        ];
    }
}
