                            ...
                            <div class="col text-center">
                                <span class="mt-2">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" target="_blank" href="https://zalo.me/0386496488"><img
                                                src="style/images/icon/zalo.png" alt="zalo"
                                        ...
                                        <a class="dropdown-item" target="_blank"
                                            href="https://www.facebook.com/dat.ds.3"><span
                                                style="
                                                background-color: #1877f2;
                                                border-radius: 4px;
                                                padding: 4px 8px 4px 8px;"><i
                                                    style="color: white" class="fab fa-facebook-f fa-lg"></i></span>
                                            Facebook</a>
                                    </div>
                                ...
                                <span class="mt-2">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false"><button class="btn-pretty">Nạp Tiền</button></a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" target="_blank"
                                            href="https://shopreroll.com/user/money/phone-card/send-card"><i
                                                class="fas fa-money-check-alt mr-1"></i> Nạp Thẻ</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" target="_blank"
                                            href="https://shopreroll.com/user/money/auto-bank/info"><i
                                                class="fas fa-university mr-1"></i> Chuyển Khoản</a>
                                    </div>
                                </span>

                                <span class="mt-2">
                                    <a href="#recharge_service"><button class="btn-pretty">Nạp Game</button></a>
                                </span>
                            </div>
                        </div>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active" style="margin-bottom: -5px;">
                                        <iframe width="100%" height="470"
                                            src="https://www.youtube.com/embed/OizK-VT4aj8" frameborder="0"
                            ...
                            <div class="col-12 col-lg-4 p-0" id="top_user">
                                <ul class="nav nav-tabs mb-2" id="MiuTopTab" role="tablist">
                                    <li class="nav-item col" role="presentation">
                                        <a class="nav-link text-uppercase text-center" id="top-tab" data-bs-toggle="tab"
                                            href="#toptab" role="tab" aria-controls="profile" aria-selected="false">Top
                                            nạp tiền
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="nav-user">
                                    ...
                                    <div class="tab-pane fade" id="anoumentTab" role="tabpanel" aria-labelledby="bounustab"
                                        style="padding: 10px;">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <center>
                                        ...
                                        <div class="row g-0 info-line">
                                            <section class="row g-0 text-center">
                                                <label class="text-muted">Đang nạp
                                                </label>
                                        ...
                                        <div class="row g-0 info-line">
                                            <section class="row g-0 text-center">
                                                <label class="text-muted">Đã nạp
                                                </label>
                                                <span class="more-detail fs-4">16</span>
                                            </section>
                                        </div>
                                        <a href="#"><button class="btn-pretty mb-4 mt-2">Nạp Ngay
                                            </button></a>
                                    </center>
                                </article>
                            @endforeach
