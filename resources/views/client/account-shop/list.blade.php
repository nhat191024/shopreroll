                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3 search-zone">
                                <section id="search-form" class="search-frm p-4 pb-5">
                                    ...
                                    <form method="get"
                                        action="{{ route('client.game.account.category', ['gameId' => $gameId, 'categoryId' => $categoryId]) }}">
                                        @foreach ($gameAttributes as $gameAttribute)
                                            <div class="col-12 mt-3">
                                                <label class="form-label">{{ $gameAttribute->name }}</label>
                                                <select class="form-control select2" name="attributes[]" multiple="multiple"
                                                    data-placeholder="Select {{ $gameAttribute->name }}">
                                                    @foreach ($gameAttribute->accountAttributes->unique('value') as $accountAttribute)
                                                        <option value="{{ $accountAttribute->id }}"
                                                            {{ in_array($accountAttribute->id, old('attributes', [])) ? 'selected' : '' }}>
                                        ...
                                        @foreach ($gameItemTypes as $gameItemType)
                                            <div class="col-12 mt-3">
                                                ...
                                                <select class="form-control select2" name="game_items[]" multiple="multiple"
                                                    data-placeholder="Select {{ $gameItemType->name }}">
                                                    @foreach ($gameItemType->gameItems->unique('name') as $accountAttribute)
                                                        <option value="{{ $accountAttribute->id }}"
                                                            {{ in_array($accountAttribute->id, old('game_items', [])) ? 'selected' : '' }}>
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <select class="form-control select2" name="price" id="price-select">
                                                <option value="">Chọn giá</option>
                                                <option value="1|10000" {{ old('price') == '1|10000' ? 'selected' : '' }}>
                                                    10k trở xuống</option>
                                                <option value="10000|50000"
                                                    {{ old('price') == '10000|50000' ? 'selected' : '' }}>10K - 50K
                                                </option>
                                                <option value="50000|100000"
                                                    {{ old('price') == '50000|100000' ? 'selected' : '' }}>50K - 100K
                                                </option>
                                                <option value="100000|200000"
                                                    {{ old('price') == '100000|200000' ? 'selected' : '' }}>100K - 200K
                                                </option>
                                                <option value="200000|300000"
                                                    {{ old('price') == '200000|300000' ? 'selected' : '' }}>200K - 300K
                                                </option>
                                                <option value="300000|400000"
                                                    {{ old('price') == '300000|400000' ? 'selected' : '' }}>300K - 400K
                                                </option>
                                                <option value="400000|500000"
                                                    {{ old('price') == '400000|500000' ? 'selected' : '' }}>400K - 500K
                                                </option>
                                                <option value="500000|800000"
                                                    {{ old('price') == '500000|800000' ? 'selected' : '' }}>500K - 800K
                                                </option>
                                                <option value="800000|1000000"
                                                    {{ old('price') == '800000|1000000' ? 'selected' : '' }}>800K - 1tr
                                                </option>
                                                <option value="1000000|2000000"
                                                    {{ old('price') == '1000000|2000000' ? 'selected' : '' }}>1tr - 2tr
                                                </option>
                                                <option value="2000000|3000000"
                                                    {{ old('price') == '2000000|3000000' ? 'selected' : '' }}>2tr - 3tr
                                                </option>
                                                <option value="3000000|4000000"
                                                    {{ old('price') == '3000000|4000000' ? 'selected' : '' }}>3tr - 4tr
                                                </option>
                                                <option value="4000000|5000000"
                                                    {{ old('price') == '4000000|5000000' ? 'selected' : '' }}>4tr - 5tr
                                                </option>
                                                <option value="5000000|6000000"
                                                    {{ old('price') == '5000000|6000000' ? 'selected' : '' }}>5tr - 6tr
                                                </option>
                                                <option value="6000000|7000000"
                                                    {{ old('price') == '6000000|7000000' ? 'selected' : '' }}>6tr - 7tr
                                                </option>
                                                <option value="7000000|8000000"
                                                    {{ old('price') == '7000000|8000000' ? 'selected' : '' }}>7tr - 8tr
                                                </option>
                                                <option value="8000000|9000000"
                                                    {{ old('price') == '8000000|9000000' ? 'selected' : '' }}>8tr - 9tr
                                                </option>
                                                <option value="9000000|10000000"
                                                    {{ old('price') == '9000000|10000000' ? 'selected' : '' }}>9tr - 10tr
                                                </option>
                                                <option value="10000000|12000000"
                                                    {{ old('price') == '10000000|12000000' ? 'selected' : '' }}>10tr - 12tr
                                                </option>
                                                <option value="12000000|15000000"
                                                    {{ old('price') == '12000000|15000000' ? 'selected' : '' }}>12tr - 15tr
                                                </option>
                                                <option value="15000000|20000000"
                                                    {{ old('price') == '15000000|20000000' ? 'selected' : '' }}>15tr - 20tr
                                                </option>
                                                <option value="20000000|25000000"
                                                    {{ old('price') == '20000000|25000000' ? 'selected' : '' }}>20tr - 25tr
                                                </option>
                                                <option value="25000000|30000000"
                                                    {{ old('price') == '25000000|30000000' ? 'selected' : '' }}>25tr - 30tr
                                                </option>
                                                <option value="30000000|999999999"
                                                    {{ old('price') == '30000000|999999999' ? 'selected' : '' }}>Trên 30tr
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-12 mt-3">
                                        ...
                                        <div class="col-12 mt-3">
                                            <label for="inpSearchHero" class="form-label">Mã số
                                            </label>
                                            <input class="form-control" name="acc_id" type="number"
                                                value="{{ old('acc_id') }}" placeholder="Điền mã số acc">
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-{{ $search ? '6' : '12' }}">
                                                    <button name="search" value="search" type="submit"
                                                        class="form-control btn btn-warning text-white font-weight-bold">
                                                ...
                                                @if ($search)
                                                    <div class="col-6">
                                                        <a href="{{ route('client.game.account.category', ['gameId' => $gameId, 'categoryId' => $categoryId]) }}"
                                                            name="clear" value="clear" type="button"
                                                            class="form-control btn btn-secondary text-white font-weight-bold">
                                            ...
                                            <div class="genshin-product">
                                                ...
                                                <div class="wrapper product-wrapper">
                                                    <a href="{{ route('client.game.account.detail', $data->id) }}">
                                                        <img class="img-banner shadow-sm" src="{{ asset($data->image) }}"
                                                    ...
                                                    <div class="row mt-1">
                                                        <div class="col-6">
                                                            <div class="btn btn-warning font-weight-bold">
                                                                <span
                                                                    class="text-danger">{{ number_format($data->price_out) }}<sup></sup></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
