            ...
            <main>
                <div>
                                ...
                                <span class="mt-2">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" target="_blank" href="https://zalo.me/0386496488">
                                            <img src="{{ asset('/image/thumb/zalo.png') }}"
                                                onerror="this.src='https://placehold.co/600x600'" alt="zalo"
                                                style="max-width: 40px; height: auto; margin-bottom: -8px; margin-top: -8px;"
                                                loading="lazy">0386496488
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" target="_blank" href="https://www.facebook.com/dat.ds.3">
                                            <span
                                                style="background-color: #1877f2; border-radius: 4px; padding: 4px 8px 4px 8px;">
                                ...
                                <span class="mt-2">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" target="_blank"
                                            href="https://shopreroll.com/user/money/phone-card/send-card">
                                            <i class="fas fa-money-check-alt mr-1"></i> Nạp Thẻ
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" target="_blank"
                                            href="https://shopreroll.com/user/money/auto-bank/info">
                            ...
                            <div id="miu-carousel" class="col-12 col-lg-8 carousel slide p-0" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active" style="margin-bottom: -5px;">
                                        <iframe width="100%" onerror="this.src='https://placehold.co/600x600'"
                                            height="470"
                                            src="https://www.youtube.com/embed/LmmfXWOvSU0?si=vxNIin1ImvaFpweu"
                                            frameborder="0"
                            ...
                            <div id="top_user" class="col-12 col-lg-4 p-0">
                                <ul id="MiuTopTab" class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item col" role="presentation">
                                        <a id="top-tab" class="nav-link text-uppercase text-center" data-bs-toggle="tab"
                                            href="#toptab" role="tab" aria-controls="profile" aria-selected="false">
                                            Top nạp tiền
                                        </a>
                                    </li>
                                </ul>
                                <div id="nav-user" class="tab-content">
                                    ...
                                    <div id="anoumentTab" class="tab-pane fade" role="tabpanel"
                                        aria-labelledby="bounustab" style="padding: 10px;">
                                    </div>
                                </div>
                            </div>
                        </section>
                                            ...
                                            <a href="{{ route('client.reroll.detail', ['id' => $rerollCategory->id]) }}">
                                                <div class="square-image-container">
                                                    <img src="{{ asset($rerollCategory->image) }}"
                                                        ...
                                                        class="square-image" loading="lazy">
                                                </div>
                                            </a>
                                        </div>
                                        <div>
                    ...
                    @foreach ($gameAccountCategories as $game)
                        ...
                        @endif
                        <center>
                            <img class="city__icon"
                                src="https://uploadstatic-sea.mihoyo.com/contentweb/20210717/2021071716211547763.png"
                                onerror="this.src='https://placehold.co/600x600'" loading="lazy">
                        </center>
