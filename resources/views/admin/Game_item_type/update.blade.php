                ...
                <div class="table-responsive">
                    <form class="form" action="{{ route('admin.game_item_type.update', [$gameItemType->id]) }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="" class="form-control" name="name" type="text" required aria-describedby="game-item-name" value="{{ $gameItemType->name }}">
                        </div>
                        <button class="btn btn-success mt-4" type="submit">Xác nhận</button>
                        <a class="btn btn-primary mt-4" href="{{ url()->previous() }}">Quay lại</a>
                    </form>
                </div>
            </div>
        </div>
